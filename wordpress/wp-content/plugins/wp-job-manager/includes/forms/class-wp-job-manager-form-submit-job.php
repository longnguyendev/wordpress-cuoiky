...
class WP_Job_Manager_Form_Submit_Job extends WP_Job_Manager_Form
{
	...
	public function init_fields()
	{
		...
		$options = ['' => __('Select a location', 'wp-job-manager')];

		$locations = get_all_job_locations();
		foreach ($locations as $location) {
			// Tách thành phần giá trị và hiển thị từ chuỗi


			// Sử dụng thành phần đầu tiên làm giá trị và thành phần thứ hai làm hiển thị


			// Thêm vào mảng options
			$options[$location] = __($location, 'wp-job-manager');
		}
