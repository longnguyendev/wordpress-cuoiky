...
class RaraThemes_Companion_Cta extends WP_Widget {
    ...
    {
        $array = apply_filters('rrtc_cta_btn_alignment_options', array(
            'right'     => 'right',
            'centered'  => 'centered'
        ));
        return $array;
    ...
    public function form( $instance ) {
        ...
        <p>
            <label for="<?php echo esc_attr( $this->get_field_id( 'button_alignment' ) ); ?>"><?php echo esc_html( $btn_alignment_title ); ?></label>
