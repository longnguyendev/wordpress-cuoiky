<?php
/**
 * JobScout Customizer Slider Control.
 * 
 * @package JobScout
*/
...
if ( ! class_exists( 'JobScout_Slider_Control' ) ){
	/**
	 * Slider control (range).
    */
	class JobScout_Slider_Control extends WP_Customize_Control {
        ...
        public function enqueue() {            
            wp_enqueue_style( 'jobscout-pro-slider', get_template_directory_uri() . '/inc/custom-controls/slider/slider.css', null );
            wp_enqueue_script( 'jobscout-pro-slider', get_template_directory_uri() . '/inc/custom-controls/slider/slider.js', array( 'jquery' ), false, true ); //for slider                
        }
