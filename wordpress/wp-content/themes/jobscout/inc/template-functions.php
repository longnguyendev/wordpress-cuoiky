...
if (!function_exists('jobscout_header')) :
    ...
    if (!function_exists('jobscout_content_start')) :
        ...
        function jobscout_content_start()
        {
            ...
            if (!(is_front_page() && !is_home() && $home_sections) && is_page_template('template-no-sidebar.php') || is_page('jobs')) { //Make necessary adjust for pg template.
    ...
    if (!function_exists('jobscout_get_single_job_title')) :
        ...
        if (!function_exists('jobscout_content_end')) :
            ...
            {
                $home_sections = jobscout_get_home_sections();
                if (!(is_front_page() && !is_home() && $home_sections) && is_page_template('template-no-sidebar.php') || is_page('jobs')) { ?>
                </div><!-- .container/ -->
