...
if( ! function_exists( 'jobscout_getting_started_menu' ) ) :
/**
 * Adding Getting Started Page in admin menu
 */
function jobscout_getting_started_menu(){	
	add_theme_page(
		__( 'Getting Started', 'jobscout' ),
		__( 'Getting Started', 'jobscout' ),
		'manage_options',
		'jobscout-getting-started',
		'jobscout_getting_started_page'
	);
}
endif;
add_action( 'admin_menu', 'jobscout_getting_started_menu' );

if( ! function_exists( 'jobscout_getting_started_admin_scripts' ) ) :
/**
 * Load Getting Started styles in the admin
 */
function jobscout_getting_started_admin_scripts( $hook ){
	// Load styles only on our page
	if( 'appearance_page_jobscout-getting-started' != $hook ) return;

    wp_enqueue_style( 'jobscout-getting-started', get_template_directory_uri() . '/inc/getting-started/css/getting-started.css', false, JOBSCOUT_THEME_VERSION );
    
    wp_enqueue_script( 'plugin-install' );
    wp_enqueue_script( 'updates' );
    wp_enqueue_script( 'jobscout-getting-started', get_template_directory_uri() . '/inc/getting-started/js/getting-started.js', array( 'jquery' ), JOBSCOUT_THEME_VERSION, true );
    wp_enqueue_script( 'jobscout-recommended-plugin-install', get_template_directory_uri() . '/inc/getting-started/js/recommended-plugin-install.js', array( 'jquery' ), JOBSCOUT_THEME_VERSION, true );    
    wp_localize_script( 'jobscout-recommended-plugin-install', 'jobscout_start_page', array( 'activating' => __( 'Activating ', 'jobscout' ) ) );
}
endif;
add_action( 'admin_enqueue_scripts', 'jobscout_getting_started_admin_scripts' );

if( ! function_exists( 'jobscout_call_plugin_api' ) ) :
/**
 * Plugin API
**/
function jobscout_call_plugin_api( $plugin ) {
...
if( ! function_exists( 'jobscout_check_for_icon' ) ) :
/**
 * Check For Icon 
**/
function jobscout_check_for_icon( $arr ) {
	if( ! empty( $arr['svg'] ) ){
...
if( ! function_exists( 'jobscout_getting_started_page' ) ) :
/**
 * Callback function for admin page.
*/
function jobscout_getting_started_page(){ ?>
	<div class="wrap getting-started">
		<h2 class="notices"></h2>
		<div class="intro-wrap">
			<div class="intro">
				<h3><?php printf( esc_html__( 'Getting started with %1$s v%2$s', 'jobscout' ), JOBSCOUT_THEME_NAME, JOBSCOUT_THEME_VERSION ); ?></h3>
				<h4><?php printf( esc_html__( 'You will find everything you need to get started with %1$s below.', 'jobscout' ), JOBSCOUT_THEME_NAME ); ?></h4>
			</div>
		</div>
			...
			<ul class="inline-list">
				<li class="current">
                    <a id="plugins" href="javascript:void(0);">
                        ...
                        <?php esc_html_e( 'Recommended Plugins', 'jobscout' ); ?>
                    </a>
                </li>
				<li>
                    <a id="help" href="javascript:void(0);">
                        ...
                        <?php esc_html_e( 'Getting Started', 'jobscout' ); ?>
                    </a>
                </li>
				<li>
                    <a id="support" href="javascript:void(0);">
                        ...
                        <?php esc_html_e( 'FAQ\'s &amp; Support', 'jobscout' ); ?>
                    </a>
                </li>
				<li>
                    <a id="free-pro-panel" href="javascript:void(0);">
                        ...
                        <?php esc_html_e( 'Free Vs Pro', 'jobscout' ); ?>
                    </a>
                </li>
			</ul>
